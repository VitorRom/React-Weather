...
export const ListaPrevisao = (props) => {
  ...
  return (
    <div className='list-container'>
      ...
      <p className='mais-informacoes-pc'>Mais informações sobre o dia de hoje</p>

      <ul className='lista-previsao'>
      <p className='mais-informacoes-mobile'>Mais informações sobre o dia de hoje</p>
        ...
        <li className='li-5'><img src='assets\uv.png  ' alt='Raios UV' className='img-UV'></img> <p>Raios UV  {textoUV}</p></li>
